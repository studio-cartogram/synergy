...
echo '<section class="prevnext">';
  ...
  if (!empty( $next_post )):
    echo '<a class="prevnext__link prevnext__link--left link secondary" href="' . get_permalink($next_post->ID) . '">';
  ...
  if (!empty( $prev_post )):
    echo '<a class="prevnext__link prevnext__link--right link secondary" href="' . get_permalink($prev_post->ID) . '">';
