...
/***/ function(module, exports, __webpack_require__) {
	...
	eval("'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _classCallCheck2 = __webpack_require__(67);\n\nvar _classCallCheck3 = _interopRequireDefault(_classCallCheck2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar Slideshow = function Slideshow() {\n  var _this = this;\n\n  (0, _classCallCheck3.default)(this, Slideshow);\n\n  this.nextSlide = function () {\n    _this.slides[_this.currentSlide].className = 'js-slide slideshow__slide';\n    _this.currentSlide = (_this.currentSlide + 1) % _this.slides.length;\n    _this.slides[_this.currentSlide].className = 'js-slide slideshow__slide is-active';\n    var height = _this.slides[_this.currentSlide].querySelector('.testimonial').clientHeight;\n    document.querySelector('#js-slideshow').style.height = _this.slides[_this.currentSlide].querySelector('.testimonial').clientHeight + 'px';\n  };\n\n  this.slides = document.querySelectorAll('#js-slideshow .js-slide');\n  this.currentSlide = 0;\n  if (this.slides.length > 0) {\n    this.slideInterval = setInterval(this.nextSlide, 8000);\n  }\n};\n\nexports.default = Slideshow;\n\n//////////////////\n// WEBPACK FOOTER\n// ./assets/js/scripts/Slideshow.js\n// module id = 379\n// module chunks = 0\n//# sourceURL=webpack:///./assets/js/scripts/Slideshow.js?");
