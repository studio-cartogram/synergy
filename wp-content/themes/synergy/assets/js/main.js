...
var _barba = __webpack_require__(404);

var _barba2 = _interopRequireDefault(_barba);

var _log = __webpack_require__(405);

var _log2 = _interopRequireDefault(_log);

var _scripts = __webpack_require__(406);

__webpack_require__(407);

var _loadSprite = __webpack_require__(408);

var _loadSprite2 = _interopRequireDefault(_loadSprite);

var _Scroll = __webpack_require__(409);

var _Scroll2 = _interopRequireDefault(_Scroll);

var _Fade = __webpack_require__(415);

var _Fade2 = _interopRequireDefault(_Fade);

var _Togglers = __webpack_require__(416);

var _Togglers2 = _interopRequireDefault(_Togglers);

var _swiper = __webpack_require__(420);

var _swiper2 = _interopRequireDefault(_swiper);

var _waypoints = __webpack_require__(422);

var _waypoints2 = _interopRequireDefault(_waypoints);

var _removeClasses = __webpack_require__(423);

var _removeClasses2 = _interopRequireDefault(_removeClasses);

var _Blob = __webpack_require__(424);
...
var _Toggle = __webpack_require__(426);
...
var App = function App() {
  ...
  this.initWaypoints = function () {
    var waypointEls = document.querySelectorAll(".js-waypoint");

    Array.prototype.forEach.call(waypointEls, function (waypoint, index) {
  ...
  this.initSlideshow = function () {
    var slideshow = new _swiper2.default(".js-slideshow", {
      navigation: {
  ...
  this.initTransitions = function () {
    ...
    var _fadeOut = _this.fade.fadeOut.bind(_this);
    var _fadeIn = _this.fade.fadeIn.bind(_this);

    _this.Transition = _barba2.default.BaseTransition.extend({
      start: function start() {
        _promise2.default.all([_fadeOut(this.oldContainer).finished, this.newContainerLoading, _scrollTop().finished]).then(this.showNewPage.bind(this));
      },
  ...
  _barba2.default.Dispatcher.on("newPageReady", function (currentStatus, oldStatus, container) {
    ...
    if (scripts.length >= 1) {
      var _sortScripts = (0, _scripts.sortScripts)(scripts),
          inlineScripts = _sortScripts.inlineScripts,
          externalScripts = _sortScripts.externalScripts;

      _promise2.default.all(externalScripts).then(function () {
        Array.prototype.forEach.call(inlineScripts, function (script) {
...
module.exports = !__webpack_require__(48) && !__webpack_require__(80)(function () {
...
var forOf = __webpack_require__(191);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(286));
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(0);
var $pad = __webpack_require__(161);
...
// https://rwaldron.github.io/proposal-math-extensions/
var $export = __webpack_require__(0);
var scale = __webpack_require__(165);
...
$export($export.S, 'Math', { scale: __webpack_require__(165) });
...
var sortScripts = exports.sortScripts = function sortScripts(scripts) {
  var externalScripts = Array.prototype.map.call(scripts, function (script) {
    return script.getAttribute('src') && getScript(script.getAttribute('src'));
  });
  var inlineScripts = Array.prototype.map.call(scripts, function (script) {
    return !script.getAttribute('src') && script;
  });
...
var _animejs = __webpack_require__(113);
...
// 19.1.2.1 Object.assign(target, source, ...)
var getKeys = __webpack_require__(119);
var gOPS = __webpack_require__(413);
...
var _createClass2 = __webpack_require__(168);
...
var Togglers = function () {
  function Togglers() {
    var buttonClass = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-toggle]';
    (0, _classCallCheck3.default)(this, Togglers);

    this.toggleButtons = document.querySelectorAll(buttonClass);
    this.bindEvents();
  }

  (0, _createClass3.default)(Togglers, [{
    key: 'bindEvents',
    value: function bindEvents() {
      var _this = this;

      Array.prototype.forEach.call(this.toggleButtons, function (button) {
        button.addEventListener('click', _this.toggle.bind(null, button));
      });
    }
  }, {
    key: 'toggle',
    value: function toggle(button) {
      var toggleEl = document.querySelector(button.dataset.toggle);
      var toggleClass = button.dataset.toggleClass || 'is-toggled';
...
var $export = __webpack_require__(46);
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !__webpack_require__(48), 'Object', { defineProperty: __webpack_require__(54).f });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dom7_dist_dom7_modular__ = __webpack_require__(421);
/**
 * Swiper 4.0.3
...
var Blob = function Blob() {
  ...
  this.init = function () {
    var morphingOne = (0, _animejs2.default)({
      targets: '#morphing .path-one',
      d: [{ value: 'M287.078125,431.007813 C373.007066,557.373859 472.490223,443.022024 474.25,248.70089 C476.09375,45.1071402 394.867188,15.4609375 254.095756,38.3828125 C171.686354,51.8015722 29.073699,104.415414 35.7327857,204.914063 C42.3918725,305.412711 163.109375,248.70089 287.078125,431.007813 Z' }],
      duration: 11000,
      loop: true,
      direction: "alternate",
    ...
    var morphingTwo = (0, _animejs2.default)({
      targets: '#morphing .path-two',
      d: [{ value: 'M374.039062,447.21875 C526.765625,347.59375 346.460938,189.070313 437.515625,98.96875 C528.570312,8.8671875 286.203125,15.4921875 185.21875,57.625 C84.234375,99.7578125 34.4375,177.609375 30.328125,312.414062 C26.21875,447.21875 221.3125,546.84375 374.039062,447.21875 Z' }],
      duration: 15000,
      loop: true,
      direction: "alternate",
      easing: "easeInOutQuad"
    ...
    var morphingThree = (0, _animejs2.default)({
      targets: '#morphing .path-three',
      d: [{ value: 'M57.578125,196.789063 C89.7114787,293.291538 190.838539,469.638838 296.109375,475.609375 C398.59375,481.421875 444.505503,335.624991 426.5,246.870473 C370.632813,-28.515625 -23.3125,-46.140625 57.578125,196.789063 Z' }],
      duration: 12000,
      loop: true,
      direction: "alternate",
      easing: "easeInOutQuad"
...
Cartogram.Toggle.prototype.init = function () {
  ...
  Array.prototype.forEach.call(this.$nodes.toggles, function (toggle) {
